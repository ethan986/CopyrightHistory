    ...
    <body>
		...
		<nav class="navbar fixed-top navbar-expand-lg shadow-sm bg-white navbar-light">
		    ...
		    <ul class="navbar-nav d-lg-flex align-items-center">
		      <li class="nav-item"><a class="nav-link @yield('faq-link')" href="{{ url('FAQ') }}">FAQ</a></li>
		      <li class="nav-item"><a class="nav-link @yield('news-link')" href="{{ url('news') }}">NEWS</a></li>
		      <li class="nav-item"><a class="nav-link @yield('ed-link')" href="{{ url('editorial-board') }}">EDITORIAL BOARD</a></li>
		      <li class="nav-item"><a class="nav-link @yield('ack-link')" href="{{ url('acknowledgements') }}">ACKNOWLEDGEMENTS</a></li>
		      <li class="nav-item"><a class="nav-link @yield('da-link')" href="{{ url('digital-archive') }}">DIGITAL ARCHIVE</a></li>
			  <li class="nav-item"><a class="nav-link @yield('con-link')" href="{{ url('contact') }}">CONTACT</a></li>
		    </ul>
